...
export const RouteCard: React.FC<RouteCardProps> = ({ route, onClear }) => {
 ...
 <button
 onClick={onClear}
 className="text-xs px-3 py-1.5 rounded-full hover:bg-black/5 text-gray-500 hover:text-black transition"
 >
 ล้างผลลัพธ์
 </button>
 </div>
 ...
 <div className="flex flex-col items-center justify-center p-3 rounded-xl bg-black/[0.02] border border-black/5 text-center">
 ...
 <div className="flex items-center gap-2 px-3 py-2.5 rounded-xl bg-yellow-500/10 border border-yellow-500/20 text-yellow-600 text-xs">
 ...
 {/* Steps Timeline */}
 <div className="flex flex-col gap-3 relative before:content-[''] before:absolute before:left-[17px] before:top-[12px] before:bottom-[12px] before:w-[2px] before:bg-black/10 max-h-[320px] overflow-y-auto pr-1">
 ...
 <div
 className={`w-3.5 h-3.5 rounded-full border-2 border-[#f5f5f7] ring-2 ${
 isInterchange
 ...
 {!isLast && (
 <div className="mt-1.5 text-[10px] opacity-65 flex items-center gap-1.5 bg-black/[0.02] py-1 px-2.5 rounded-lg w-fit">
 {isInterchange ? (
 <>
