...
const regex = /export const stationCoords: Record<string, \{ x: number; y: number \}> = \{[\s\S]*?\n\};\n/;
const replacement = `export const stationCoords: Record<string, { x: number; y: number }> = ${coords};\n`;
